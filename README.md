...
An iOS app to track your PlayStation Network trophies, built with SwiftUI.
...
- **PSN Comparison** — Compare your trophies with another player on a specific game, with friends list support
...
2. Open `PlayStationTrophies.xcodeproj` in Xcode
3. Build and run on your device
4. Sign in with your PSN account via the sync menu
